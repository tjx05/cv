...
PARSED_GT_PATH = os.path.join(DATA_DIR, 'parsed_groundtruth.json') # 我们预处理生成的 JSON
...
# ==========================================
# 2. 特征提取参数 (Feature Extraction)
# ==========================================
SIFT_MAX_FEATURES = 3000      # 每张图最多提取的特征点数量 (防内存溢出)
USE_ROOT_SIFT = True          # 开启 RootSIFT 提分利器
...
# ==========================================
# 4. 检索与重排参数 (Retrieval & RANSAC - 为 Day 4 预留)
# ==========================================
TOP_N_PREFILTER = 100         # 倒排索引初筛保留的前 N 张候选图
