...
def aqe_retrieval(top_k_expand=5):
    ...
    for query_name, gt_info in tqdm(gt_data.items(), desc="AQE 检索中"):
    ...
    print("==================================================")
    print(f"🏆 AQE 扩展系统构建完毕！最终 mAP 得分: {mAP_score:.4f}")
    print("==================================================")
