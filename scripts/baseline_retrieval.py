...
try:
    ...
    print("⚠️ 找不到 tools/evaluate_map.py，请确保该文件存在！")
    sys.exit(1)
...
def search_image(query_img_path, bbox, extractor, kmeans, index_data):
    ...
    # 5. 利用倒排索引进行极速相似度计算 (Cosine Similarity)
...
def run_baseline_evaluation():
    ...
    print("==================================================")
    print(f"🏆 Baseline 系统构建完毕！最终 mAP 得分: {mAP_score:.4f}")
    print("==================================================")
